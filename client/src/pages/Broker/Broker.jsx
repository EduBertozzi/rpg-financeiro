    ...
    <GameLayout>
      <div className="max-w-5xl mx-auto p-8 space-y-6">
        ...
        <div className="flex gap-2">
          <button onClick={() => setTab('market')} className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${tab === 'market' ? 'bg-primary text-white' : 'bg-card border border-border text-gray-400 hover:text-white'}`}>Mercado</button>
          <button onClick={() => setTab('portfolio')} className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${tab === 'portfolio' ? 'bg-primary text-white' : 'bg-card border border-border text-gray-400 hover:text-white'}`}>Minha Carteira</button>
        </div>
